...
export const BigDataCenter: React.FC = () => {
  ...
  const openPerson = (person?: Person) => {
    ...
    setPersonModal(true);
    setImpact(null);
    if (person?.id) void loadImpact('PERSON', person.id);
  };
